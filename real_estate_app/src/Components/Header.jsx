    ...
    <div className='bg-white border-b shadow-sm sticky top-0 z-55'> 
      <header className='flex justify-between items-center px-3 max-w-6xl mx-auto'>
        <div className='flex items-center'>
            <img src='favicon.ico' alt='logo' className='h-6 cursor-pointer' onClick={() => navigate('/')}></img>
    ...
    <span className='text-blue-500'>HomeFinder.ro</span>
        ...
        <div>
            <ul className='flex space-x-10 text-lg'> 
                ...
                <li className={`cursor-pointer py-3 text-sm font-semibold text-gray-400 border-b-[3px] border-b-transparent ${matchRoute('/sign-in') && "text-black border-b-red-500"} ` } onClick={() => navigate('/sign-in')}>Sign in</li>
            </ul>
        </div>
      </header>
    </div>
